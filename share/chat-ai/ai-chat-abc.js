var _base_url_ = "/share/chat-ai/";
var _api_domain_ = "http://localhost:80";
...
function d() {
  ...
  t.type = "text/css", t.rel = "stylesheet", t.href = i + _base_url_ + "style.css", document.getElementsByTagName("head")[0].appendChild(t);
}
class m {
  constructor(t) {
    e(this, "iframe", null);
  ...
  open() {
    this.iframe.style.display = "block", this.postMessage("openWindow", { href: window.location.href });
  }
  close() {
...
function g() {
  let a = {
    iframeSrc: _api_domain_ + _base_url_ + "#/chat",
    remote: "",
    params: {}
  };
